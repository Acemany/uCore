...
import ucore.scene.utils.Selection;
...
public class Tree extends WidgetGroup{
    ...
    private ucore.scene.event.ClickListener clickListener;
    ...
    private void initialize(){
        addListener(clickListener = new ucore.scene.event.ClickListener(){
