...
import ucore.lights.shaders.DiffuseShader;
import ucore.lights.shaders.Gaussian;
import ucore.lights.shaders.ShadowShader;
import ucore.lights.shaders.WithoutShadowShader;
    ...
    public void render(){
        ...
        if(rayHandler.shadows){
            ...
            if(RayHandler.isDiffuse){
                shader = rayHandler.customDiffuseShader != null ? rayHandler.customDiffuseShader : diffuseShader;
                shader.begin();
                rayHandler.diffuseBlendFunc.apply();
                shader.setUniformf("ambient", c.r, c.g, c.b, c.a);
                shader.setUniformf("tint", rayHandler.tintColor);
            }else{
                shader.begin();
